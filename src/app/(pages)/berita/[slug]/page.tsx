...
import {
  GET_NEWS_BY_SLUG,
  LIST_NEWS,
} from "@/graphql/queries/berita/beritaQueries";
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      ScrollTrigger.create({
        ...
        onEnter: () => {
          const lineElements =
            ornamentLineRef.current?.querySelectorAll("img, div");
          if (lineElements) {
            gsap.fromTo(
              lineElements,
              {
  ...
  return (
    <main ref={mainRef}>
      ...
      <div className="flex flex-col relative mt-[-2vw] md:mt-[-10vw] overflow-hidden">
        ...
        >
          <Image
            src={ornamentArrowLeft}
            alt="ornament arrow left"
            className="w-[2vw]"
          />
          <Image
            src={ornamentArrowRight}
            alt="ornament arrow right"
            className="w-[2vw] "
          />
        ...
        <div className="relative w-full px-[2vw] flex sm:flex-row gap-[2vw] justify-center mb-[10vw] mt-[3vw]">
          ...
          <Image
            src={ornamentBgSubpage}
            alt="bg ornament subpage"
            className="absolute  bottom-0 -z-10"
          />

          <div
            ref={contentSectionRef}
            className="w-[100%] sm:w-[80%] absolute  top-[8%] left-[3%]  "
          >
            <Image
              ref={ornamentDecoRef}
              src={ornament}
              ...
              <div className="flex flex-col sm:flex-row items-center  sm:items-start  sm:gap-4 md:gap-12 ">
                {totalImages > 0 && (
                  ...
                  >
                    <button
                      onClick={() =>
                        setImageIdx((prev) => Math.max(prev - 1, 0))
                      }
                      disabled={imageIdx === 0}
                ...
                <div className="flex-1 flex flex-col order-1 sm:order-2">
                      ...
                      <div className="w-full h-full flex items-center justify-center text-gray-400">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="3"
                            d="M24 38.05A14.05 14.05 0 0038.05 24 14.05 14.05 0 0024 9.95 14.05 14.05 0 009.95 24 14.05 14.05 0 0024 38.05z"
                          />
                          <path
                            stroke="currentColor"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            strokeWidth="3"
                            d="M19 24.03l5.13 5.12 10.12-10.12"
                          />
                        </svg>
                  ...
                  <div className="relative w-full">
                    <div className="leading-[5vw]">
                      ...
                      <div ref={metaRef}>
                        <p className="text-[#0538B9] text-[clamp(2.5vw,2.5vw,1.5rem)] mb-6 text-justify">
                    ...
                    <div
                      ref={contentTextRef}
                      className="news-content-scrollbar  sm:mt-0 text-[#0538B9] text-[clamp(1.5vw,3vw,2rem)] sm:text-[clamp(1.5vw,1.5vw,1.5rem)] h-[23vw] sm:h-[17vw] md:h-[20vw] overflow-y-auto text-justify sm:mt-[3vw] mt-[4vw] mb-2"
                    >
                      {news.content}
                    </div>
                  </div>
