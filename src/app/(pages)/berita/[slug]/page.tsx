...
export default function BeritaDetailPage() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.fromTo(ornamentLineRef.current,
                {
                    scaleX: 0,
                    opacity: 0
                },
            ...
            ScrollTrigger.create({
                ...
                onEnter: () => {
                    ...
                    gsap.fromTo(detailHeaderRef.current,
                        {
                            x: -200,
                            opacity: 0,
                            scale: 0.9
                                ...
                                <div className="flex-1 flex flex-col order-1 md:order-2">
                                    ...
                                    <div className="relative w-full">
                                        <div className="leading-[3.5vw]">
                                            <h1 ref={titleRef} className="text-[clamp(5vw,5vw,4rem)] font_bold text-[#002787] text-justify">{news.title}</h1>
                                            <div ref={metaRef}>
