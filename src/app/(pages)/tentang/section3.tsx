...
export default function Section3() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(
        ".anim-mori-3",
        { xPercent: 100, opacity: 0, ease: "bounce.out", duration: 1.2 },
        "-=1"
      );
      tl.from(
        ".anim-touch-group",
        { y: -50, opacity: 0, scale: 0.8, stagger: 0.2 },
        "-=0.8"
      );
      ...
      tl.from(
        leftContent,
        { x: -50, opacity: 0, stagger: 0.25, ease: "back.out(1.4)" },
        "-=1.2"
      );
    }, containerRef);
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full mt-[5vw] overflow-hidden py-12 sm:py-0 text-justify"
    >
      <div className="flex sm:flex-row flex-col justify-between items-center w-11/12 mx-auto z-20">
        <div className="flex flex-col items-center sm:w-7/12 w-full justify-center z-20 gap-y-8">
          ...
          <p className="text-[#0049FF] sm:text-[clamp(1.5vw,1.5vw,1rem)] text-[clamp(3.5vw,3.5vw,1.5rem)] font_regular bg-[#BACEFF] rounded-[2vw] p-[2.3vw] anim-left-stagger">
          ...
          <div className="flex flex-row items-center gap-x-[3vw] bg-[#BACEFF] rounded-[2vw] p-[2.3vw] anim-left-stagger">
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#0049FF] text-[clamp(2.5vw,2vw,1.5rem)] font_bold w-[6vw] text-center leading-[2.5vw]">
                Warna Biru
              </p>
            </div>
            <div className="flex flex-col items-center">
              <h1 className="bg-gradient-to-b from-[#3488CF] to-[#002C99] w-[4vw] h-[4vw] rounded-full" />
              <p className="text-[#0049FF] text-[clamp(2.5vw,2vw,1.5rem)] font_bold w-[8vw] text-center leading-[2.5vw]">
                Warna Gradiasi
              </p>
            </div>
            <p className="text-[#0049FF] sm:text-[clamp(1.5vw,1.5vw,1rem)] text-[clamp(3.5vw,3.5vw,1.5rem)] font_regular">
