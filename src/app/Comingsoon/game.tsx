                ...
                {botChoice && (
                  <>
                    ...
                    <Image
                      ...
                      alt="pilihan bot"
                      className="relative xl:w-auto lg:w-[400px] md:w-[330px] sm:w-[250px] w-[60vw] sm:h-auto h-[40vw]"
                    />
                  </>
                )}
              </div>
                ...
                {userChoice && (
                  <>
                    ...
                    <Image
                      ...
                      alt="pilihan user"
                      className="relative xl:w-[100%] lg:w-[400px] md:w-[330px] sm:w-[250px] w-[60vw] sm:mb-0 mb-[-25px] sm:h-auto h-[40vw]"
                    />
                  </>
                )}
              </div>
