...
import gemay from '../../assets/icons/gemay.svg';
import gemay2 from '../../assets/icons/gemay-2.svg';
import calendarIcon from '../../assets/icons/calendar.svg';
import bubblechat from '../../assets/background/landingpage/bubblechat.svg';
import logo from '../../../../public/Assets/logo/logoEM.svg';
import borderkalender from '../../assets/background/landingpage/border-kalender.svg';
import deskripsimori from '../../assets/background/landingpage/deskripsi-mori.svg';
import eclipse from '../../assets/icons/landingpage/welcome-eclipse.svg';
import decor from '../../assets/icons/landingpage/welcome-decor-1.svg';
import line from '../../assets/icons/landingpage/Line.svg';
...
export default function Welcome() {
  ...
  return (
    <section className="relative w-full px-4 md:px-16 py-10 flex flex-col gap-14 items-center bg-white">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-[610px] md:top-[-50px] z-10">
        <div className="bg-[#FF4900] flex items-center justify-center rounded-full w-[156px] h-[156px] p-4">
          <Image src={ArrowUpRight} alt="arrow" width={60} height={60} />
        </div>
      </div>
