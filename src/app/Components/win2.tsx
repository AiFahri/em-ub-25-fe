  ...
  return (
    <div className="absolute inset-0 flex justify-center items-center flex-col z-50">
      <motion.div
        ...
        className="absolute"
      >
        <Image src={confetti} alt="confetti animation" className="w-full h-full" />
      </motion.div>
      ...
      <div className="flex flex-col  items-center justify-center space-y-0">
        <div className="flex flex-row font_bold py-0  text-[4rem] sm:text-[5rem] md:text-[6rem] lg:text-[8rem] xl:text-[10rem] tracking-normal relative z-20">
          <Image src={o} alt="comingsoon" className="absolute translate-y-[290%] md:translate-x-[450%]  translate-x-[485%] md:translate-y-[270%]  xl:w-[67px] lg:w-[55px] md:w-[40px] sm:w-[35px] w-[25px] z-30 " />
