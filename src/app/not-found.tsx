...
useEffect(() => {
  ...
  return (
    <div className=" relative flex justify-center overflow-hidden items-center flex-col min-h-screen bg-[#001B5E]  ">
      ...
      <div className="flex flex-row absolute items-center z-50 justify-center font_bold whitespace-nowrap space-x-6 text-[3rem] sm:text-[5rem] md:text-[6rem] lg:text-[8rem] xl:text-[173.32px]">
        <Image src={gemay} alt="coming soon" className="absolute left-0 mb-1  lg:w-16 md:w-12 sm:w-10 w-6 xl:w-auto" />
