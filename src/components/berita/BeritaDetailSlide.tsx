  ...
  return (
    <div className="relative w-full flex justify-center items-start z-10 px-4">
      ...
      <div className="relative w-full max-w-[1400px]">
        {/* Tab heading */}
        <div className="flex items-center mb-[-2px] ml-12 z-20">
        ...
        <div
          className={clsx(
            "relative w-full   bg-gradient-to-br from-[#E8F1FF] to-[#D6E8FF] border-4 border-blue-700 px-16 py-16 flex flex-row gap-16 overflow-visible shadow-2xl"
          )}
          style={{
        ...
        >
          ...
          <div className="flex flex-row gap-8 flex-1">
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      idx === imageIdx 
                        ...
                        : "border-blue-700 bg-white hover:bg-blue-50"
                    )}
            ...
            <div className="flex flex-col flex-1 min-w-[500px] max-w-[700px] pt-2">
              {/* Title */}
              <h1 className="text-6xl font-black text-blue-900 mb-4 leading-tight tracking-tight">
                {news?.title || "Loading..."}
              </h1>
              ...
              {news?.ministryName && (
                <div className="mb-8">
                  <span className="inline-block border-3 border-blue-700 bg-white text-blue-900 px-8 py-3 rounded-2xl font-bold text-xl shadow-lg">
                    {news.ministryName}
                  </span>
                </div>
              )}
              ...
              >
                {news?.content
                  ? expanded
                    ? news.content
                    : limitWords(news.content, MAX_WORDS_PREVIEW)
                  : <span className="italic text-blue-400">Belum ada isi berita.</span>
                }
              </div>
...
>
     ...
     <span className="absolute right-4 bottom-4 z-10">
        <span className="bg-white rounded-[20px] px-4 py-2 flex items-center justify-center shadow-md border-2 border-blue-500"
          style={{
