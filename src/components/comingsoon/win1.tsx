...
import light from "@/assets/comingsoon/images/light.svg";
import bg from "@/assets/comingsoon/images/bg_text.svg";
import mori from "@/assets/logo/mori.svg";
import whitelogo from "@/assets/logo/whitelogo.svg";
import o from "@/assets/comingsoon/icons/o2.svg";
...
export default function Win1() {
  return (
    <div className="absolute inset-0 flex justify-center items-center flex-colz-50">
      <motion.div
        className="absolute w-full h-full sm:h-11/12"
        animate={{ rotate: 360 }}
      ...
      >
        <Image
          src={light}
          alt="spinning light"
          className="h-full w-full brightness-150 blur-sm saturate-150 opacity-90 animate-pulse"
        />
      </motion.div>
      ...
      <div className="flex flex-col  items-center justify-center space-y-0 z-20  ">
        <div className="flex flex-row font_bold py-0  text-[4rem] sm:text-[5rem] md:text-[6rem] lg:text-[8rem] xl:text-[10rem] tracking-normal relative z-20">
          <Image
            src={o}
            alt="comingsoon"
            className="absolute translate-y-[290%] md:translate-x-[450%] md:translate-y-[270%]  translate-x-[485%]  xl:w-[67px] lg:w-[55px] md:w-[40px] sm:w-[35px] w-[25px] z-30 "
          />
        ...
        <div className="relative flex flex-row items-center justify-center ">
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center ">
            <p className="font_medium text-white tracking-tight xl:text-[42px] lg:text-[36px] md:text-[24px] text-[10px] relative z-20 text-nowrap">
              You&apos;re one of the few to get this far. Congrats!
            </p>
          </div>
        </div>
        <Image
