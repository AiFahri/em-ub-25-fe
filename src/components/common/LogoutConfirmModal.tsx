...
export default function LogoutConfirmModal({ isOpen, onClose, onConfirm }: { isOpen: boolean; onClose: () => void; onConfirm: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center font-[NeueHaasDisplay] bg-[#001B5E]/90">
      <div className="relative bg-[#E8F0FF] rounded-2xl px-6 md:px-10 py-8 w-[90%] max-w-[500px] font-light overflow-auto text-center text-[#0538B9] shadow-xl">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Konfirmasi Logout</h2>
        <p className="text-sm md:text-lg mb-6 whitespace-pre-wrap">Apakah kamu yakin ingin logout?</p>
