...
export default function WelcomeDesktop() {
  ...
  return (
    <motion.section
      ...
      variants={fadeUp}
      className="relative w-full px-4 md:px-16 py-10 flex flex-col gap-14 items-center bg-white"
    >
      <div className="flex flex-col md:flex-row items-start w-full relative">
        <motion.div
          custom={1}
          variants={fadeUp}
          className="absolute z-10 top-[-4vw] left-[33vw]"
        >
          <motion.div
            whileHover={{ scale: 1.1, y: -3 }}
            transition={{ type: "spring", stiffness: 300, damping: 15 }}
            className="bg-[#FF4900] flex items-center justify-center rounded-full w-[9vw] h-[9vw] p-4"
          >
            <motion.img
        ...
        <motion.div
          custom={2}
          variants={fadeUp}
          className="flex flex-col gap-6 relative items-center md:items-start w-full md:w-[45%]"
        >
          <div className="relative w-full">
            ...
            <motion.div
              custom={3}
              variants={fadeUp}
              className="absolute top-[7vw] left-[18vw] z-10"
            >
              <div className="relative w-[25vw] h-[10vw] flex items-center justify-center">
                ...
                <div className="absolute text-white text-[clamp(1vw,2vw,4vw)] font-semibold px-4 text-center whitespace-nowrap overflow-hidden">
                  <Typewriter
                    onInit={(typewriter) => {
                      typewriter
                        .typeString("Halo, aku adalah Mori!")
                        .pauseFor(1500)
                        .deleteAll()
                        .start();
                    }}
            ...
            <motion.div
              whileHover={{ rotate: [0, -8, 8, -6, 6, -4, 4, 0] }}
              transition={{ duration: 1.5, ease: "easeInOut" }}
              className="absolute top-[4vw] left-[6vw] z-20 md:w-[10vw]"
            >
              <Image
                src={gemay}
                alt="dekor"
            ...
            <motion.div
              whileHover={{ x: [0, -10, 10, -8, 8, -4, 4, 0] }}
              transition={{ duration: 1.5, ease: "easeInOut" }}
              className="absolute bottom-[8vw] -right-[5vw] z-20 w-[8vw]"
            >
              <Image
                src={gemay2}
                alt="dekor"
          ...
          <motion.div
            custom={4}
            variants={fadeUp}
            className="relative mt-10 w-[40vw] md:h-[25vw]"
          >
            <Image
              src={borderkalender}
              alt="Border Kalender"
            ...
            <div className="w-full pl-[5vw] flex items-center justify-between h-full font-[NeueHaasDisplay]">
              <div className="flex flex-col justify-center mt-5">
                <p className="text-[7vw] font-bold text-[#0538B9] leading-none">
                  2025
                </p>
        ...
        <motion.div
          custom={5}
          variants={fadeUp}
          className="flex flex-col items-center md:items-end gap-6 w-full"
        >
          <div className="w-full flex justify-end font-[NeueHaasDisplay]">
            <motion.h2
              custom={6}
              variants={fadeUp}
              className="text-black text-[clamp(2.5vw,3vw,6vw)] font-bold flex flex-col"
            >
              ...
              <span className="flex flex-wrap gap-x-2">
                {["Sobat", "Mori!"].map((word, i) => (
                  <motion.span
                    ...
                    className={
                      i === 0
                        ? "text-[#0538B9] text-[clamp(7vw,6vw,7vw)]"
                        : "text-[#0538B9] text-[clamp(7vw,6vw,7vw)]"
                    }
                  >
                    {word}
          ...
          <motion.div
            custom={7}
            variants={fadeUp}
            className="flex flex-col items-end gap-4 w-full max-w-screen-md mx-auto"
          >
            <h3 className="bg-[#FF4900] text-white font-medium font-[NeueHaasDisplay] text-[clamp(1.2vw,3vw,4vw)] px-6 py-2 rounded-full">
              Ekspresi Mori
            </h3>
          ...
          >
            ...
            <div className="z-20 inverted-radius-descmori min-h-[10vw] px-6 pt-6 pb-10 sm:pb-12">
              ...
              >
                ...
                >
                  Mori adalah teman kecilmu yang siap memandu petualangan seru
                  di dunia EM UB 2025. Mau mencari info kegiatan? Dokumentasi
                  kece? Atau sekadar kepo sama EM UB?
                </motion.p>
                <motion.p
                ...
                >
                  Tenang saja, Mori siap nemenin kamu keliling. Ayo klik-klik
                  bareng Mori, ya. Jangan takut nyasar, soalnya Mori hafal semua
                  jalan di sini!
                </motion.p>
              </motion.div>
            </div>
            <Image
              src={eclipse}
              alt="Eclipse dekor"
              className="absolute bottom-[3vw] left-[-2vw] w-[5vw]"
            />
            <div className="absolute inset-0 -z-10">
              ...
              <Image
                src={decor}
                alt="Decor"
                className="absolute bottom-[-5.8vw] right-[19vw] w-[8vw]"
              />
            </div>
          </motion.div>
        </motion.div>
