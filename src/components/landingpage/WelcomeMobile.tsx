...
export default function WelcomeMobile() {
  ...
  return (
    <motion.section
      ...
      variants={fadeUp}
      className="w-full flex justify-center px-4 sm:px-8 pt-6 pb-10"
    >
      <div className="max-w-[600px] sm:max-w-[700px]">
        <motion.div custom={0} variants={fadeUp} className="text-start mb-4">
          <h2 className="text-[clamp(5vw,8vw,5.8vw)] leading-3 text-black font-medium">
            Selamat Datang,
          </h2>
          <h2 className="text-[clamp(12vw,15vw,13vw)] font-bold text-[#0538B9]">
            Sobat Mori!
          </h2>
        </motion.div>
        ...
        >
          <div className="relative w-full aspect-square">
            <motion.div
              custom={2}
              variants={fadeUp}
              className="absolute top-[15%] right-0 w-[60%] z-20"
            >
            ...
            <motion.div
              custom={3}
              variants={fadeUp}
              className="absolute top-[-10%] right-[0%] md:top-[-12%] md:right-[-13%] z-10"
            >
              <motion.div
                whileHover={{
                  scale: 1.15,
            ...
            <Image
              src={gemay}
              alt="dekor"
              className="absolute top-[10%] left-[5%] w-[25%] z-10"
            />
            <Image
              src={ciclelightblue}
              alt="dekor"
              className="absolute bottom-[25%] right-[5%] w-[13%] sm:w-[13%] z-10"
            />
            <Image
              src={oneshape}
              alt="dekor"
              className="absolute top-[48%] right-2 w-[6%] sm:w-[7%] z-10"
            />
          </div>
        </motion.div>
        ...
        >
          <h3 className="bg-[#FF4900] text-white text-2xl font-semibold px-4 py-2 rounded-full mb-4">
            Ekspresi Mori
          </h3>
        ...
        >
          <div className="inverted-radius-descmori min-h-[300px] px-6 pt-6 pb-10 sm:pb-12">
            <div className="text-[#002787] text-lg sm:text-xl px-6 leading-relaxed font-[NeueHaasDisplay] text-end">
              <p>
                Mori adalah teman kecilmu yang siap memandu petualangan seru di
                dunia EM UB 2025. Mau mencari info kegiatan? Dokumentasi kece?
                Atau sekadar kepo sama EM UB?{" "}
              </p>
              <p className="mt-4 pl-[3rem]">
        ...
        <motion.div
          custom={6}
          variants={fadeUp}
          className="relative w-full flex px-2 sm:px-4"
        >
          <div className="relative w-full max-w-[300px] sm:minw-[350px] sm:max-w-[400px] border-4 border-[#0538B9] rounded-full py-6 px-4 sm:px-6 flex items-center gap-4 bg-white">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-[32px] sm:text-[48px] font-bold text-[#0538B9] leading-none">
                2025
              </p>
