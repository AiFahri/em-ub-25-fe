...
const ChatButton: React.FC<ChatButtonProps> = ({ children, size }) => {
    ...
    const clipPathId = `chat-button-shape-${uniqueId}`;

        const visualsStyle: MyCSSProperties = {
        clipPath: `url(#${clipPathId})`, // 4. Terapkan ID unik ke clipPath
    };
    ...
    return (
        <>
            ...
            <button className={styles.chatButton} style={buttonStyle}>
                <span className={styles.buttonVisuals} style={visualsStyle}>
