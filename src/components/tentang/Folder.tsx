...
const Folder: React.FC<FolderProps> = ({ nama, imageUrl, isHovered, isDimmed, isActive, shadowColor }) => {
    ...
    return (
        ...
        >
            ...
            />
            <div 
                className='font-semibold text-[clamp(2.5vw,2.5vw,5rem)] sm:text-[clamp(1vw,1.7vw,1.5rem)] w-full h-full absolute top-0 left-0 flex text-start items-end text-white p-[1.5vw] leading-tight justify-start'
            >
                {nama}
            </div>
        </div>
